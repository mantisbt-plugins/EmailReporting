...
ERP_output_config_option( 'mail_engine', 'dropdown', NULL, 'print_descriptions_option_list', array( 'PEAR', 'Horde/Imap_Client (Legacy)', 'Horde/Imap_Client (Modern)', 'Javanile/PHP-IMAP2', 'Webklex/PHP-IMAP', 'ZetaComponents/Mail' ) );
