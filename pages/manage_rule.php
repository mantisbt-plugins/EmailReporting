...
ERP_output_config_option( 'cond_issue_creation_method', 'dropdown_any', $t_rule, 'print_descriptions_option_list', array( 'emailreporting', 'mantisbt' ) );// TODO think about name and think this over whether selected mailboxes should be here or on the manage mailboxes page
...
ERP_output_config_option( 'cond_issue_issue_issuenote', 'dropdown_any', $t_rule, 'print_descriptions_option_list', array( 'newnote', 'newissue' ) ); //TODO note or new issue
